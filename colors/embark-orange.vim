...
let g:colors_name='embark-orange'
set background=dark
...
" Space
let s:space0 = { "gui": "#160e08", "cterm": "232", "cterm16": "0"}
let s:space1 = { "gui": "#221710", "cterm": "233", "cterm16": "NONE"}
let s:space2 = { "gui": "#2e2113", "cterm": "233", "cterm16": "NONE" }
let s:space3 = { "gui": "#3f2e1d", "cterm": "236", "cterm16": "8"}
let s:space4 = { "gui": "#5c4a33", "cterm": "236", "cterm16": "8"}

" Astral
let s:astral0 = {"gui": "#b09a7c", "cterm": "252", "cterm16": "15"}
let s:astral1 = { "gui": "#f4d9b3", "cterm": "253", "cterm16": "7"}

" Nebula
let s:red = { "gui": "#e0704a", "cterm": "204", "cterm16": "1"}
let s:dark_red = { "gui": "#c74a00", "cterm": "203", "cterm16": "9"}

let s:green = { "gui": "#a8c48a", "cterm": "120", "cterm16": "2"}
let s:dark_green = { "gui": "#8fae6f", "cterm": "119", "cterm16": "10"}

let s:yellow = { "gui": "#ffc457", "cterm": "228", "cterm16": "3"}
let s:dark_yellow = { "gui": "#e89a52", "cterm": "215", "cterm16": "11"}

let s:blue = { "gui": "#e8a86b", "cterm": "159", "cterm16": "4"}
let s:dark_blue = { "gui": "#d98e4a", "cterm": "135", "cterm16": "13"}

let s:purple = { "gui": "#d9a07a", "cterm": "141", "cterm16": "5"}
let s:dark_purple = { "gui": "#b07040", "cterm": "75", "cterm16": "12"}

let s:cyan = { "gui": "#e8c4a0", "cterm": "122", "cterm16": "6"}
let s:dark_cyan = { "gui": "#cf9465", "cterm": "121", "cterm16": "14"}
...
let s:diff_del = { "gui": "#4a2a1a", "cterm": "203", "cterm16": "9"}
let s:diff_add = { "gui": "#2a3a22", "cterm": "119", "cterm16": "10"}
let s:diff_changed = { "gui": "#3f2e14", "cterm": "215", "cterm16": "11"}
